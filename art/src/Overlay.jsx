      ...
      <section id="part2" className="h-screen ">
        ...
        <div className="flex  bg-black ">
          <button
            ...
            className={`z-50 px-6 text-5xl font-allura ${
        ...
        <div className="w-1/2">
          ...
          {activeTab === "Tab2" && (
            <p className="text-white text-xl">
              ...
              comedy; also, according to the Greek poet Hesiod, a Grace (one of
              a group of goddesses of fertility). She is the mother of the
              Corybantes, celebrants of the Great Mother of the Gods, Cybele,
              the father being Apollo, a god related to music and dance. In her
              hands she carried the comic mask and the shepherd’s staff.
            </p>
          )}
          {activeTab === "Tab3" && (
            <p className="text-white text-xl">
